...
/// <summary>
/// Nota de Débito Electrónica (ND) - Documento tipo 02
/// Usada para ajustes positivos a facturas o tiquetes previamente emitidos
/// </summary>
[XmlRoot("NotaDebitoElectronica", Namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.4/notaDebitoElectronica")]
public class NotaDebitoElectronica
{
    ...
    /// <summary>
    /// Resumen de totales de la nota de débito
    /// </summary>
