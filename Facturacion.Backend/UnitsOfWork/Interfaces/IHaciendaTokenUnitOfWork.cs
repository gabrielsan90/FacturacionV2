...
/// <summary>
/// Unit of Work para gestionar operaciones con tokens de Hacienda
/// </summary>
public interface IHaciendaTokenUnitOfWork
{
    /// <summary>
    /// Obtiene el token activo más reciente de una empresa
    /// </summary>
    Task<ActionResponse<HaciendaToken>> GetTokenActivoAsync(Guid empresaId, string ambiente);

    /// <summary>
    /// Obtiene todos los tokens de una empresa
    /// </summary>
    ...
    /// <summary>
    /// Invalida todos los tokens activos de una empresa
    /// </summary>
